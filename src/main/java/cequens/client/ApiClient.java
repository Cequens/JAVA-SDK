...
import cequens.client.auth.Authentication;
import cequens.client.auth.HttpBasicAuth;
import cequens.client.auth.ApiKeyAuth;
import cequens.client.auth.OAuth;
...
public class ApiClient {
     ...
     */    
    public static final String LENIENT_DATETIME_FORMAT = "MM-dd-yyyy hh:mm:ss";
    //public static final String LENIENT_DATETIME_FORMAT = "yyyy-MM-dd'T'HH:mm:ss.SSSZ";

    private String basePath = "http://api.cequens.com/cequens/api/v1";
    ...
    public ApiClient() {
        ...
        setUserAgent("cequens/1.0.0/java");

        // Setup authentications (key: authentication name, value: authentication).
        authentications = new HashMap<String, Authentication>();
        authentications.put("accessToken", new OAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.cequens.com/cequens/api/v1
    ...
    public String parameterToString(Object param) {
        if (param == null) {
            ...
            Date obj = ((DateTime)param).toDate();
    ...
    private void initDatetimeFormat() {
        ...
        this.datetimeFormat = new SimpleDateFormat("MM-dd-yyyy hh:mm:ss");
    }
